...
export default function Package() {
  ...
  return (
    <>
      <Helmet>
        <title>Luxury World Tour Packages | Global Trip International</title>
        <meta name="description" content="Discover exclusive world tour packages with Global Trip International. From Europe to Dubai, Maldives to Singapore — luxury stays, seamless travel loans, and premium services await." />
        <meta name="keywords" content="world tour packages, international holidays, luxury vacations, honeymoon tours, travel loans, Global Trip International, family travel" />
      </Helmet>
